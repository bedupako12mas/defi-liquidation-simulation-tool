...
import { classifyFluidAssets } from "../routes/fluidShockClassification.js";
import { applyShock, SHOCK_PRESETS } from "../engine/shockModel.js";
import { healthFactor } from "../engine/healthFactor.js";
import { computeExpectedMaxLiquidatableDebt, estimateAaveLiquidationGas } from "../validation/aaveValidator.js";
...
import { resolveFluidOverrideTarget, estimateFluidLiquidationGas, validateFluidLiquidation } from "../validation/fluidValidator.js";
import { redactError } from "../rpc/redact.js";
import type { LiquidationProfitabilityTable } from "../db/types.js";
import type { Insertable } from "kysely";
import type { AssetShockConfig } from "../engine/shockModel.js";
import type { PriceVector } from "../engine/types.js";

/**
 * Lives under src/, not scripts/, for the same reason src/sync/validationResults.ts does -
 * see that file's top comment. k8s/base/sync-profitability-job.yaml's `node
 * dist/sync/liquidationProfitability.js` is what actually executes this.
 *
...
export async function runSyncLiquidationProfitability(): Promise<boolean> {
  try {
