...
// A known two-pool T4 vault from the full census (col-debt shape).
const TWO_POOL_VAULT = "0xB170B94BeFe21098966aa9905Da6a2F569463A21" as const;
...
async function main() {
  ...
  console.log(JSON.stringify(resolution, (_, v) => (typeof v === "bigint" ? v.toString() : v), 2));
}
