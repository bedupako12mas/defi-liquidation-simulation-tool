...
const VAULTS = [
  "0x43d1cA906c72f09D96291B4913D7255E241F428d",
  "0x57A9f4e109EcEF8990BC794df0D159fb29861f2A",
] as const;
...
async function main() {
  ...
  for (const v of VAULTS) {
    ...
    console.log(v, "liquidationThreshold(bps):", data.configs.liquidationThreshold, "collateralFactor(bps):", data.configs.collateralFactor);
  }
}
