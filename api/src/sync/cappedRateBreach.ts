...
import { resolveFluidOverrideTarget } from "../validation/fluidValidator.js";
import { startAnvilFork } from "../fork/anvilFork.js";
import { buildFixedReturnBytecode } from "../validation/stateOverride.js";
import { redactError } from "../rpc/redact.js";
import { parseAbi } from "viem";
import type { Insertable } from "kysely";
import type { CappedRateBreachResultsTable } from "../db/types.js";
...
export async function runSyncCappedRateBreach(): Promise<boolean> {
  try {
