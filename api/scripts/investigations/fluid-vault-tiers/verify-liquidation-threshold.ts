...
async function main() {
  ...
  console.log("liquidationThreshold (bps):", data.configs.liquidationThreshold);
  console.log("collateralFactor (bps):", data.configs.collateralFactor);
  console.log("liquidationPenalty (bps):", data.configs.liquidationPenalty);
}
main().catch((err) => {
